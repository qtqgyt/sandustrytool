...
class Config:
    ...
    def reset_config(self):
        """Reset config file to defaults by removing it"""
        try:
            if os.path.exists(self.CONFIG_FILE):
